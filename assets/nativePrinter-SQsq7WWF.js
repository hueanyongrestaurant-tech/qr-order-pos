...
`),e.items.forEach(l=>{const $=t==="en"?l.item.name.en:l.item.name.th;o(i,D(`${l.quantity}x ${$}`,`${W(l)}${n.thb}`)+`
`);const E=Z(l,t);E&&o(i,`  ${E}
